<?php 
	...
	if(isset($_POST['submit'])){
		...
		// ambil 1 id terbesar di kolom id_pendaftaran, ambil 5 karakter aja dari sebelah kanan
...
<head>
	...
	<img src="Unbaja.png" alt="LOGO UNBAJA" width="120px" >
</head>
<body>
	<!-- bagian box formulir -->
	<section class="box-formulir">
	<h2>Pendaftaran Mahasiswa Baru Unbaja</h2>
